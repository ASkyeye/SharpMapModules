...
namespace GetLsassSessions
{
    ...
    internal class Utility
    {
        ...
        private static extern NtStatus NtReadVirtualMemory(IntPtr ProcessHandle, IntPtr BaseAddress, byte[] Buffer, UInt32 NumberOfBytesToRead, ref UInt32 NumberOfBytesRead);
        ...
        public static byte[] ReadFromLsass(ref IntPtr hLsass, IntPtr addr, long bytesToRead)
        {
            ...
            NtStatus status = NtReadVirtualMemory(hLsass, addr, bytev, (uint)bytesToRead, ref bytesRead);
        ...
        public static string ExtractUnicodeStringString(IntPtr hLsass, UNICODE_STRING str)
        {
            ...
            byte[] resultBytes = ReadFromLsass(ref hLsass, (IntPtr)str.Buffer, str.MaximumLength);
